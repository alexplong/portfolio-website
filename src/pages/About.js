      ...
      >
        ...
        <div className="p-6">
          <p>
            ...
            dedicated to life-long learning mentality. I am a full stack
            developer with a background in JavaScript, React, and several coding
            languages with experience developing mobile applications and
            building websites.
            <br />
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row justify-between">
              <LabeledContainer
                className=""
                Class="left-10  text-neon-blue bg-off-black bg-opacity-0"
